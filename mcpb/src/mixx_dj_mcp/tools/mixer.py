...
async def mixx_mixer(
    ...
    try:
        ...
        if operation == "crossfader_set":
            ...
            return {
                "success": True,
                "message": f"Deck {deck} gain set to {val:.2f}",
                "data": {"deck": deck, "gain": val},
            }
            ...
            return {
                "success": True,
                "message": f"Deck {deck} EQ {eq_band} set to {val:.2f}",
                "data": {"deck": deck, "band": eq_band, "value": val},
            }
            ...
            return {
                "success": True,
                "message": f"Deck {deck} volume set to {val:.2f}",
                "data": {"deck": deck, "volume": val},
            }
            ...
            return {
                "success": True,
                "message": f"Deck {deck} headphone cue {'on' if enable else 'off'}",
            ...
            return {
                "success": True,
                "message": f"Talkover {'enabled' if enable else 'disabled'}",
                "data": {"enable": enable},
            }
