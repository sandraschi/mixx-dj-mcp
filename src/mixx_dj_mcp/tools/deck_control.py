...
async def mixx_deck(
    ...
    try:
        ...
        if operation == "play_pause":
            ...
            return {
                "success": True,
                "message": f"Deck {deck}: loading track",
                "data": {"deck": deck, "track_path": track_path},
            }
            ...
            return {
                "success": True,
                "message": f"Deck {deck}: loop {'enabled' if enable else 'disabled'}",
                "data": {"deck": deck, "enable": enable},
            }
            ...
            return {
                "success": True,
                "message": f"Deck {deck}: {beats_val}-beat loop",
                "data": {"deck": deck, "beats": beats_val},
            }
            ...
            return {
                "success": True,
                "message": f"Deck {deck}: rate set to {val:+.3f}",
                "data": {"deck": deck, "rate": val},
            }
            ...
            return {
                "success": True,
                "message": f"Deck {deck}: temporary pitch bend",
                "data": {"deck": deck, "duration": value},
            }
            ...
            return {
                "success": True,
                "message": f"Deck {deck}: sync {'enabled' if enable else 'disabled'}",
                "data": {"deck": deck, "enable": enable},
            }
            ...
            return {
                "success": True,
                "message": f"Deck {deck}: sync leader {'set' if enable else 'unset'}",
                "data": {"deck": deck, "enable": enable},
            }
            ...
            return {
                "success": True,
                "message": f"Deck {deck}: seeked to {value}s",
                "data": {"deck": deck, "position": value},
            }
            ...
            return {
                "success": True,
                "message": f"Deck {deck}: scratch {'enabled' if enable else 'disabled'}",
                "data": {"deck": deck, "enable": enable},
            }
            ...
            return {
                "success": True,
                "message": f"Deck {deck}: hotcue {hotcue_num} activated",
                "data": {"deck": deck, "hotcue": hotcue_num},
            }
            ...
            return {
                "success": True,
                "message": f"Deck {deck}: quantize {'enabled' if enable else 'disabled'}",
                "data": {"deck": deck, "enable": enable},
            }
            ...
            return {
                "success": True,
                "message": f"Deck {deck}: keylock {'enabled' if enable else 'disabled'}",
                "data": {"deck": deck, "enable": enable},
            }
            ...
            return {
                "success": True,
                "message": f"Deck {deck}: video {'enabled' if enable else 'disabled'}",
                "data": {"deck": deck, "enable": enable},
            }
            ...
            return {
                "success": True,
                "message": f"Deck {deck}: video fullscreen {'on' if enable else 'off'}",
                "data": {"deck": deck, "enable": enable},
            }
