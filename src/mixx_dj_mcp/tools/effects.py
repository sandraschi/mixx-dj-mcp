...
async def mixx_effects(
    ...
    try:
        ...
        if operation == "list_effects":
            ...
            return {
                "success": True,
                "message": f"Effect chain cleared (rack {rack}, unit {unit})",
                "data": {"rack": rack, "unit": unit},
            }
            ...
            return {
                "success": True,
                "message": f"Meta knob set to {val:.2f}",
                "data": {"rack": rack, "unit": unit, "value": val},
            }
            ...
            return {
                "success": True,
                "message": f"Quick effect set on deck {deck}: {effect}",
                "data": {"deck": deck, "effect": effect},
            }
            ...
            return {
                "success": True,
                "message": f"Effect unit {'enabled' if enable else 'disabled'}",
                "data": {"rack": rack, "unit": unit, "enable": enable},
            }
